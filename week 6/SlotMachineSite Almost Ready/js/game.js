...
function playSlots() {
    ...
    //This approach has the validation occuring in another function , that function will handle the styling of the form for invalid
...
function validBet(bet) {
    var document.getElementById("slotsOutput");
    var theErrorMessage = " ";
    ...
    if (bet > playerCash) {
        ...
        theErrorMessage = "the negative number allowed";
